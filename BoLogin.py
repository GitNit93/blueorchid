...
for tab in allTabs:
    ...
    if (driver.current_url=="http://blueorchid.ghsdomain.com/en/hotels/gb/london/london-tower-suites?location=All%20Blue%20Orchid%20Hotel&locationtype=Hotel&lid=0&checkin=10%20Jul%202020&checkout=11%20Jul%202020&RoomsSelector=1-0&rateaccesscode="):
